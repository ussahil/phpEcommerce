          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              ...
              <div class="row border-top py-3 mt-3">
                <div class="col-sm-4">
                  <img src="<?php echo $item['item_image'] ?? './assets/bigBed2.jpg' ?>" alt="<?php echo $item['item_name'] ?? 'unknown'  ?>" class="img-fluid">
                </div>
                <div class="col-sm-4">
              ...
              <div class="font-roboto text-danger font-size-20 ">
                <span>Rs</span> <?php echo $item['item_price'] ?? 0  ?>
              </div>
              <div class="col">
                <div class="qty d-flex pt-2 ">
                  <div class=" font-rale flex-none">
