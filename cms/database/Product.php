...
class Product
{
  ...
  public function deleteCart($item_id =null, $table ='product',$sql_col_name = 'item_id'){
   ...
   public function newProduct($brand,$name,$price,$img)
   {
    $result = $this->db->conn->query("INSERT INTO `product` (`item_brand`, `item_name`, `item_price`, `item_image`) VALUES ('{$brand}','{$name}','{$price}','{$img}');");
